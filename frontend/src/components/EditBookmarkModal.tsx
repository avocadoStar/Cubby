...
export default function EditBookmarkModal({ bookmark, onClose, onSaved }: {
  ...
  return (
    <ModalBase title="编辑书签" onClose={onClose} width="360px" closeOnEscape closeOnOverlayClick={false}>
      <form onSubmit={handleSave}>
        ...
        <div className="flex justify-end gap-2">
          <button type="button" onClick={onClose} className="h-8 px-4 rounded text-sm cursor-default bg-app-card border border-input-border text-app-text shadow-app-base">取消</button>
