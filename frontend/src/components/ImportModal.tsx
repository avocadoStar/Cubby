      ...
      <div className="bg-white border border-[#e0e0e0] rounded-lg shadow-xl p-6 w-96" onClick={(e) => e.stopPropagation()}>
        ...
        {status === 'done' && (
          <div className="text-center py-4">
            ...
            <button onClick={handleDone} className="mt-4 h-8 px-6 border-none rounded bg-[#0078D4] text-white text-[13px] font-medium cursor-default hover:bg-[#0066b3]">
              完成
            </button>
          </div>
        )}
        ...
        {status === 'error' && (
          <div className="text-center py-4">
            ...
            <div className="flex justify-center gap-2">
              ...
              <button onClick={handleRetry} className="h-8 px-4 border-none rounded bg-[#0078D4] text-white text-[13px] font-medium cursor-default">重试</button>
            </div>
          </div>
        )}
      </div>
